...
This Code of Conduct applies within all project spaces (e.g., GitHub
repository, issue tracker, pull requests) and in public spaces when an
...
`indra020204@gmail.com`. All complaints will be reviewed and investigated
promptly and fairly.
